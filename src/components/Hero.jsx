...
export default function Hero() {
  ...
  return (
    <div className="flex flex-col justify-start items-center py-24 bg-[#FFFFFF] dark:bg-[#141414] transition-colors duration-300">
      {/* Headings */}
      ...
      <div className="relative mt-8">
        {/* Circle */}
        <div className="w-60 h-60 sm:w-80 sm:h-80 rounded-full bg-[#1B1B1B] dark:bg-[#1B1B1B] flex justify-center items-center transition-colors duration-300">
          <motion.img
        ...
        {/* Social Icons */}
        <FaDribbble className="hidden sm:block absolute top-32 -right-40 w-20 h-20 p-4 rounded-full  dark:bg-[#1B1B1B] text-[#141414] dark:text-[#E1E1E1] transition-colors duration-300" />
        <FaApple className="hidden sm:block absolute top-0 -right-64 rotate-12 rounded-full text-6xl  text-[#141414] dark:text-white transition-colors duration-300" />
        <FaDropbox className="hidden sm:block absolute top-48 -left-24 rotate-12 rounded-full text-6xl  text-[#141414] dark:text-white transition-colors duration-300"  />
        {/* circles fill */}
        <div className="rounded-full bg-black absolute top-[21rem] -left-4 dark:bg-white w-5 h-5"></div>
        {/* circles left top */}
        <div className="rounded-full border border-black w-5 h-5 dark:border-white absolute top-36 -left-44"></div>
        {/* circles left bottom */}
        <div className="rounded-full border border-black w-5 h-5 absolute top-72 -left-24  dark:border-white"></div>
        {/* circles right-top */}
        <div className="rounded-full border border-black w-5 h-5 dark:border-white absolute top-1 -right-4"></div>

        {/* a icon */}
        <div className="text-7xl absolute top-8 -left-64 text-white flex items-center justify-center rounded-full bg-black dark:bg-[#1b1b1b] w-24 h-24">
        ...
        <svg
          viewBox="0 0 98 96"
          class="w-24 h-24 text-black dark:text-white stroke-current fill-none absolute top-0 -left-32"
        ...
        <svg
          viewBox="0 0 100 100"
          class="w-16 h-16 text-black dark:text-white fill-current absolute top-72 -right-16"
        >
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="text-black dark:fill-white absolute top-2 -right-36 rotate-12 scale-75"
        >
          <path
