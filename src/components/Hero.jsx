  ...
  return (
    <div className="relative flex flex-col justify-start items-center py-16 bg-[#FFFFFF] dark:bg-[#141414] transition-colors duration-300">
      ...
      <section className="relative mt-8">
        {/* Circle */}
        <div className="relative z-[100] w-60 h-60 sm:w-80 sm:h-80 rounded-full dark:bg-[#1B1B1B] flex justify-center items-center transition-colors duration-300">
          <motion.img
        ...
        <div className="">
          ...
          <svg
            viewBox="0 0 98 96"
            class="w-24 h-24 text-black hidden sm:block dark:text-white stroke-current fill-none absolute top-0 -left-32"
          ...
          <svg
            viewBox="0 0 100 100"
            class="w-16 h-16 hidden sm:block text-black dark:text-white fill-current absolute top-72 -right-16"
          >
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="text-black hidden sm:block dark:fill-white absolute top-2 -right-36 rotate-12 scale-75"
          >
            <path
