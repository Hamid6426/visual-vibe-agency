  ...
  return (
    <div className="relative flex flex-col justify-start items-center py-16 bg-[#FFFFFF] dark:bg-[#141414] transition-colors duration-300">
      ...
      <section className="relative mt-8">
        {/* Circle */}
        <div className="relative z-[100] w-60 h-60 sm:w-80 sm:h-80 rounded-full bg-[#1B1B1B] flex justify-center items-center transition-colors duration-300">
          <motion.img
        ...
        <div className="">
          ...
          <motion.div
            ...
            className="hidden sm:block absolute top-32 -right-40 rounded-full dark:bg-[#1B1B1B] text-[#141414] dark:text-[#E1E1E1] transition-colors duration-300 "
          >
          ...
          <motion.div
            ...
            animate={rotateLogo ? { x: 0, y: 0, scale: 1 } : {}}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="hidden sm:block absolute top-0 -right-64 rotate-12 rounded-full text-6xl text-[#141414] dark:text-white z-10"
          >
            <FaApple />
          </motion.div>
          ...
          <motion.div
            ...
            animate={rotateLogo ? { x: 0, y: 0, scale: 1 } : {}}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="hidden sm:block absolute top-48 -left-24 rotate-12 rounded-full text-6xl z-10 text-[#141414] dark:text-white transition-colors duration-300"
          >
            <FaDropbox />
          </motion.div>

          {/* <FaDropbox className="hidden sm:block absolute  rounded-full text-6xl  " /> */}

          {/* circles fill */}
          <div className="hidden sm:block rounded-full bg-black absolute top-[21rem] -left-4 dark:bg-white w-5 h-5"></div>

          <motion.div
            initial={{ x: 200, y: 10 }}
            animate={rotateLogo ? { x: 0, y: 0 } : {}}
            transition={{ duration: 0.6, delay: 0.4 }}
            className="hidden sm:block rounded-full border border-black w-5 h-5 absolute top-36 -left-44 dark:border-white"
          />

          {/* circles left bottom */}
          <div className="hidden sm:block rounded-full border border-black w-5 h-5 absolute top-72 -left-24  dark:border-white"></div>

          {/* circles right-top */}
          <div className="hidden sm:block rounded-full border border-black w-5 h-5 dark:border-white absolute top-1 -right-4"></div>

          {/* a icon */}
          <div className="hidden sm:flex text-7xl absolute top-8 -left-64 text-white items-center justify-center rounded-full bg-black dark:bg-[#1b1b1b] w-24 h-24">
          ...
          <svg
            viewBox="0 0 98 96"
            className="w-24 h-24 text-black hidden sm:block dark:text-white stroke-current fill-none absolute top-0 -left-32"
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="text-black hidden sm:block fill-black dark:fill-white absolute top-2 -right-36 rotate-12 scale-75"
          >
            <path
          ...
          <motion.div
            ...
            animate={rotateLogo ? { x: 0, y: 0, scale: 1 } : {}}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="hidden sm:block absolute top-80 -right-16 rotate-12 rounded-full text-6xl z-10 text-[#141414] dark:text-white transition-colors duration-300"
          >
            <svg
              viewBox="0 0 100 100"
              className="w-16 h-16 hidden sm:block text-black dark:text-white fill-current"
            >
